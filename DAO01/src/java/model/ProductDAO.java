...
public class ProductDAO {
    ...
    private ProductDTO mapToPrd(ResultSet rs) throws SQLException {
        ...
        return new ProductDTO(id, name, description, price, size, status);
    }
    ...
    public boolean update(ProductDTO product) {
        ...
        try ( Connection conn = DbUtils.getConnection();) {
            ...
            st.setString(4, product.getSize());
            st.setBoolean(5, product.isStatus());
            st.setString(6, product.getId());
    ...
    public List<ProductDTO> retrieveByStatus(boolean status){
        return retrieve("status = ?", true);
    }
